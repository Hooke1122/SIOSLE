...
%  Batch file for small-sized experiments corresponding to table 1  %
%  Setting:                                                         %
%  order number B = 9, 12, 15 or 18                                 %
%  upper limit X = 10, 13, 16 or 19                                 %
%  a = -0.01, and (tau, R) = (0.5, 0.5)                             %
%                                                                   %
        ...
        for tandR = 2:2 
            for a = 12:12
            	for TestTime = 1:20
                    ...
                    dircsv = ['../InstanceAndresult/table1/instances/' csv];
                    ...
                    try
                        ...
                        decom_listDetail = [];
                        tic
                        [ResultOrder,ResultFromtime] = SOOSLEBB(S,Epsilon,P0,D0,1);
                        cumsumTemp = [];
