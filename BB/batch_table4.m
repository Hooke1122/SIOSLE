...
%  Batch file for large-sized experiments corresponding to table 4  %
%  Setting:                                                         %
%  order number B = 60, 80, 100, 120, 140                           %
%  upper limit X = 100, 140, 180, 220                               %
%  a = -0.08, and (tau, R) = (0.5, 0.5)                             %
%                                                                   %
        ...
        for tandR = 2:2
            for a = 15:15
            	for TestTime = 1:20    
                    ...
                    dircsv = ['../InstanceAndresult/table4/instances/' csv];
